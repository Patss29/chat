...
<template>
        <div class="flex">
  <!-- Conversations list -->
  <section class="md:w-1/3 bg-white rounded-lg shadow overflow-hidden mr-5 flex flex-col">
    ...
    <div v-if="users.length" class="flex-1 overflow-y-auto divide-y">
    ...
    <div v-else-if="!loading && users.length === 0" class="flex-1 flex items-center justify-center h-64">
